...
export const assets = {
    ...
    export const blog_data = [{
        ...
        description:"In today’s fast-paced world of web development, choosing the right framework can significantly impact a project's scalability, performance, and long-term maintainability. Next.js, built on top of React, has rapidly become a favorite among developers due to its seamless developer experience, built-in routing, and powerful rendering capabilities. With the introduction of newer versions like Next 13 and 15, developers are now embracing features like the app directory, server components, and enhanced routing mechanisms that simplify both frontend and backend integration. This evolution pushes developers to think more modularly and build applications that are not only faster but also more maintainable. Whether you’re creating a small blog or a full-scale SaaS platform, understanding these shifts is crucial to staying productive and relevant in the ever-changing tech landscape. ",
        image:blog_pic_1,
        date:Date.now(),
        category:"Lifestyle",
        author:"Alex Bennett",
